  ...
  return (
    <section className="bg-zinc-950 py-32 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-12 lg:px-16">
        ...
        <div className="relative rounded-[40px] border border-white/5 bg-linear-to-b from-zinc-900/30 to-zinc-900/5 p-8 sm:p-12 md:p-20 backdrop-blur-xl overflow-hidden shadow-2xl">
          ...
          <div className="grid gap-16 lg:grid-cols-12 lg:items-center relative z-10">
            ...
            <div className="lg:col-span-8 space-y-8">
              <div>
                ...
                <h2
                  className="mt-6 text-4xl font-light tracking-tight text-white sm:text-5xl md:text-6xl leading-[1.1]"
                ...
                <p className="mt-6 max-w-2xl text-base font-light leading-relaxed text-zinc-400 antialiased">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <Link
                  href="/consultation"
                  className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-amber-400 px-8 py-4 text-xs font-semibold uppercase tracking-widest text-black transition-all duration-500 hover:shadow-[0_0_35px_rgba(251,191,36,0.25)]"
                >
                ...
                <Link
                  href="/gallery"
                  className="group inline-flex items-center justify-center rounded-full border border-white/10 bg-white/[0.02] px-8 py-4 text-xs font-semibold uppercase tracking-widest text-white backdrop-blur-md transition-all duration-300 hover:bg-white hover:text-black hover:border-white"
                >
            ...
            {/* RIGHT COLUMN: REALIGNED STRUCTURAL METRICS ACCORD */}
            <div className="lg:col-span-4 lg:border-l lg:border-white/5 lg:pl-12 w-full">
              <div className="grid gap-10 sm:grid-cols-3 lg:grid-cols-1">
                {metrics.map((metric) => (
                  <div 
                    key={metric.label} 
                    className="group flex flex-col justify-center border-l-2 border-zinc-800 pl-6 lg:border-l-0 lg:border-b lg:border-white/5 lg:pb-6 lg:pl-0 last:border-0 last:pb-0"
                  >
                    <h3 
                      className="text-4xl sm:text-5xl font-light tracking-tight text-white transition-colors duration-300 group-hover:text-amber-400 select-none"
                      style={{ fontFamily: "var(--font-heading), var(--font-playfair), serif" }}
                    >
                      {metric.value}
                    </h3>
                    <p className="mt-1 text-xs font-light uppercase tracking-widest text-zinc-400 group-hover:text-amber-100/70 transition-colors duration-300">
                      {metric.label}
                    </p>
                  </div>
                ))}
